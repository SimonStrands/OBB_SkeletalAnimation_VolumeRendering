...
static void buildTestSkeleton(){
	testSkeleton.id = 0;
	testSkeleton.parent.init(sf::Vector2f(0,0), sf::Vector2f(50,10));
	testSkeleton.children.push_back(Bone());

	testSkeleton.children[0].id = 1;
	testSkeleton.children[0].parent.init(sf::Vector2f(40,0), sf::Vector2f(50,10));
	testSkeleton.children[0].children.push_back(Bone());

	testSkeleton.children[0].children[0].id = 2;
	testSkeleton.children[0].children[0].parent.init(sf::Vector2f(80,0), sf::Vector2f(50,10));
}
